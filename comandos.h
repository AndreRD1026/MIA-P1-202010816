...
class Comando{
    public:
        ...
        void reporte_inode(string nombresalida, string path, string id);
        void reporte_journaling(string nombresalida, string path, string id);
        void reporte_block(string nombresalida, string path, string id);
        ...
        void reporte_tree(string nombresalida, string path, string id);
